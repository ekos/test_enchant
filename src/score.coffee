  ...
  constructor: (x, y) ->
    ...
    for i in [0..Score.STR_INDEX.length]
      ...
      if @score_num == 0
        ...
        @num_sprite[0].frame = Score.NUM_INDEX[@score_num / 10000]
      ...
      if @score_num == 0
        ...
        @num_sprite[1].frame = Score.NUM_INDEX[@score_num % 10000 / 1000]
      ...
      if @score_num == 0
        ...
        @num_sprite[2].frame = Score.NUM_INDEX[@score_num % 1000 / 100]
      ...
      if @score_num == 0
        ...
        @num_sprite[3].frame = Score.NUM_INDEX[@score_num % 100 / 10]
      ...
      if @score_num == 0
        ...
        @num_sprite[4].frame = Score.NUM_INDEX[@score_num % 10]
